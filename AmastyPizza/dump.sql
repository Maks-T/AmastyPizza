...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=617245131ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Недавние таблицы" class="drop_button btn">Недавнее</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=amasty&table=orders">`amasty`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=amasty&table=sizes">`amasty`.`sizes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=amasty&table=price_pizza">`amasty`.`price_pizza`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=amasty&table=sauces">`amasty`.`sauces`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=amasty&table=pizza">`amasty`.`pizza`</a></li></ul></div><div class="drop_list"><button title="Избранные таблицы" class="drop_button btn">Избранное</button><ul id="pma_favorite_list"><li class="warp_link">Нет избранных таблиц.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="746b47522c32266e2b6e2a3a6c476b6c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Нажмите Enter для выполнения запроса                    </span>
                            ...
                            targetdb="amasty" targettable="price_pizza">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `price_pizza`</span>
                        </div>
            ...
            Запрошенное время
                            ...
                            <span class="query">INSERT INTO `price_pizza` (`id_pizza`, `price`) VALUES (&#039;1&#039;, &#039;12.20&#039;), (&#039;2&#039;, &#039;13.12&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="amasty" targettable="price_pizza">
                            <div class="action_content">
            ...
            Запрошенное время
                            ...
                            <span class="query">INSERT INTO `price_pizza` (`id_pizza`, `price`) VALUES (&#039;3&#039;, &#039;14.15&#039;), (&#039;4&#039;, &#039;15.22&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="amasty" targettable="price_pizza">
                            <div class="action_content">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `price_pizza`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="amasty" targettable="sizes">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT * FROM `sizes`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="amasty" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Свернуть
                    </span>
            ...
            Запрошенное время
                            ...
                            <span class="query">TRUNCATE `orders`;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="amasty" targettable="orders">
                            <div class="action_content">
            ...
            Запрошенное время
                            ...
                            <span class="query">SELECT pizza.name, sauces.name, sizes.name, summary
FROM orders
INNER JOIN pizza ON orders.id_pizza=pizza.id JOIN sauces ON orders.id_sauces=sauces.id JOIN sizes ON orders.id_sizes=sizes.id;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="amasty" targettable="orders">
                            <div class="action_content">
